package com.wenfee.design.prototype.demo_01;
...
public class QuestionBankController {
     ...
     * @param testNumber {@code testNumber} 考号
     * @return 试卷信息
     */
    public String createTestPage(String candidate, String testNumber) {
        // 解答题
        ...
        choiceQuestionList.add(new ChoiceQuestion("下列是JAVA所定义的版本为", map01, "E"));
